	...
	void update() { 
        ...
        foreach( key ; images.keys()){
			...
			if(i.imgtype!=SHAPE && i.animation_mode!=ANIM_NONE){
				...
				if(i.clock.getElapsedTime().asMilliseconds()>i.animation_length*1000/i.animation_frames){
                    i.clock.restart();
                    i.curr_frame+=1;
                ...
                i.sprite.textureRect=IntRect(i.sprite_width*i.curr_frame,0,i.sprite_width,i.sprite_height);
			}
		}
	}	
}